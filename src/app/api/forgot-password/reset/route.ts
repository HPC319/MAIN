 ...
 * New code should use: src/kernel/actions/auth.actions.ts -> forgotPassword
 * 
...
export async function POST(_request: Request | undefined) {
  return NextResponse.json(
    {
      error: 'DEPRECATED: Use Server Action forgotPassword from @/kernel/actions/auth.actions',
