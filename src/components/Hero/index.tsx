            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Trade-agnostic Next.js template designed and built
                  for any business vertical. It comes with all necessary integrations,
                  pages, and components you need to launch a feature-rich
                  application.
                </p>
