...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <MotionWrapper className="group mb-12">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-primary">
          <span className="absolute left-0 top-0 z-[-1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-2xl bg-primary/20 group-hover:rotate-45"></span>
          {icon}
        </div>
