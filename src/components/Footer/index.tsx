...
const Footer = () => {
  ...
  const productsLinks = [
    { href: "#", label: "LineIcons" },
    { href: "#", label: "Next.js Templates" },
    { href: "#", label: "TailAdmin" },
    { href: "#", label: "PlainAdmin" },
  ];
    ...
    <FadeIn direction="up" delay={0.15}>
      <FooterContainer>
        <FooterGrid>
          ...
          <FooterColumn width="2/12">
            <FooterLinks title="About Us" links={aboutLinks} />
          </FooterColumn>

          <FooterColumn width="3/12">
            <FooterLinks title="Features" links={featuresLinks} />
          </FooterColumn>

          <FooterColumn width="3/12">
            <FooterLinks title="Our Products" links={productsLinks} />
          </FooterColumn>

          <FooterColumn width="6/12">
        ...
        <FooterBottom>
          <FooterGrid>
            <FooterColumn width="2/3" className="md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <FooterLink href="#" className="px-3">
                    Privacy policy
                  </FooterLink>
                  <FooterLink href="#" className="px-3">
                    Legal notice
            ...
            <FooterColumn width="1/3" className="md:w-1/3 lg:w-1/2">
        ...
        <div>
          ...
          <span className="absolute right-0 top-0 z-[-1]">
            <svg width="102" height="102" viewBox="0 0 102 102" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.8667 33.1956C2.89765 33.1956 3.7334 34.0318 3.7334 35.0633C3.7334 36.0947 2.89765 36.9309 1.8667 36.9309C0.835744 36.9309 4.50645e-08 36.0947 0 35.0633C-4.50645e-08 34.0318 0.835744 33.1956 1.8667 33.1956Z" fill="white" fillOpacity="0.08" />
              <path d="M18.2939 33.1956C19.3249 33.1956 20.1606 34.0318 20.1606 35.0633C20.1606 36.0947 19.3249 36.9309 18.2939 36.9309C17.263 36.9309 16.4272 36.0947 16.4272 35.0633C16.4272 34.0318 17.263 33.1956 18.2939 33.1956Z" fill="white" fillOpacity="0.08" />
              {/* Additional dots omitted for brevity */}
            </svg>
          </span>
        </div>
      </FooterContainer>
